...
public class MarketplaceWebServiceProductsSampleConfig {
    ...
    private static final String accessKey = Construct.ACCESS_KEY_ID;

    /** Developer AWS secret key. */
    private static final String secretKey = Construct.SECRET_ACCESS_KEY;

    /** The client application name. */
    private static final String appName = Construct.APP_NAME;

    /** The client application version. */
    private static final String appVersion = Construct.APP_VERSION;

    /**
     * The endpoint for region service and version.
     * ex: serviceURL = MWSEndpoint.NA_PROD.toString();
     */
    private static final String serviceURL = "https://mws.amazonservices.jp";
